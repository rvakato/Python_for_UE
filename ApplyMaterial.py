...
source_instance_path = "/Game/Stage/Materials/Brick/Brick_Camtech_Fuji/Brick_Camtech_Fuji_1"  # Path to the source material instance
output_instance_folder = "/Game/Stage/Materials/Brick/Brick_Camtech_Fuji/"  # Folder to save the duplicated instances
texture_folder = "/Game/Stage/Materials/Brick/Brick_Camtech_Fuji/"  # Folder containing the textures
texture_name_prefix = "Brick_Camtech_Fuji_"  # Prefix for textures
...
for i in range(1, 31):  # Loop through 1 to 30
    ...
    base_color_texture_path = f"{texture_folder}{texture_name_prefix}{i}_color"
    normal_texture_path = f"{texture_folder}{texture_name_prefix}{i}_normal"
    roughness_texture_path = f"{texture_folder}{texture_name_prefix}{i}_roughness"
